function data = osp_import_Tarquin_data_fit_baseline(filename, startRow, endRow)
%IMPORTFILE1 Import numeric data from a text file as a matrix.
%   data = IMPORTFILE1(FILENAME) Reads data from text
%   file FILENAME for the default selection.
%
%   data = IMPORTFILE1(FILENAME, STARTROW, ENDROW) Reads
%   data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   data = importfile1('Tarquin_fit.txt', 3, 8194);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/01/07 14:46:01
...
formatSpec = '%f%f%f%f%*s%*s%*s%*s%*s%*s%*s%*s%[^\n\r]';
