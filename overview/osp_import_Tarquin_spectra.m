                    ...
                    if ~strcmp (d1(i,1).name(1), '.')
                        if strcmp(d1(i,1).name(end-4), 't')
                            if ~exist('metab')
                                ...
                                MRSCont.overview.Tarquin.all_models.(name){1,j}.fittCr  = MRSCont.overview.Tarquin.all_models.(name){1,j}.(['fit' dataNames{idx_Cr}]) + MRSCont.overview.Tarquin.all_models.(name){1,j}.(['fit' dataNames{idx_PCr}]) + MRSCont.overview.Tarquin.all_models.(name){1,j}.(['fit' dataNames{idx_3}]);
