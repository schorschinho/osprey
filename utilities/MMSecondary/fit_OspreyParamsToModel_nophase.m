function [ModelOutput] = fit_OspreyParamsToModel_nophase(inputData, inputSettings, fitParams)
...
ph0         = 0; % zero-order phase correction [convert from deg to rad]
ph1         = 0; % first-order phase correction [convert from deg/ppm to rad/ppm]
