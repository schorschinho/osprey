...
opts.saveVendor             = 1;                % OPTIONS:    - 0 (no, default)
                                                %             - 1 (yes)
% opts.fit.basisSetFile    = '/Users/helge/Documents/GitHub/osprey/fit/basissets/user/BASIS_noMM.mat';                                            
...
opts.fit.includeMetabs      = {'Ala','Asp','Cr','CrCH2' ...
                     ,'GABA','GPC','GSH','Glc','Gln','Glu' ...
                     ,'Ins','Lac','NAA','NAAG','PCh','PCr' ...
                     ,'Scyllo','Tau','MM09' ...
                     ,'MM12','MM14','MM17','MM20','Lip09','Lip13','Lip20'};      % OPTIONS:    - {'default'}
                                                %             - {'full'}
                                                %             - {custom}                                     
                                                
% Choose the fitting algorithm
opts.fit.method             = 'OspreyNoLS';       % OPTIONS:    - 'Osprey' (default)
                                                %           - 'AQSES' (planned)
                                                %           - 'TARQUIN' (planned)
...
% (MANDATORY)
files       = {which('extdata/philips_spar_sdat_WS.SDAT')};
...
% (MANDATORY)
outputFolder = strrep(which('extdata/jobSDAT_ABfit.m'),'jobSDAT_ABfit.m','derivatives');
