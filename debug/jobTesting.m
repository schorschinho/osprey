...
% (MANDATORY)
files       = {which('debug/quickDebug/sub-01/mrs/sub-01_hermes/sub-01_hermes_act.sdat'),...
               which('debug/quickDebug/sub-02/mrs/sub-02_hermes/sub-02_hermes_act.sdat')};
...
% default.
files_ref   = {which('debug/quickDebug/sub-01/mrs/sub-01_hermes_ref/sub-01_hermes_ref.sdat'),...
               which('debug/quickDebug/sub-02/mrs/sub-02_hermes_ref/sub-02_hermes_ref.sdat')};
