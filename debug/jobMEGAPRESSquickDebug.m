...
% (MANDATORY)
files       = {which('debug/quickDebug/sub-01/mrs/sub-01_megapress/sub-01_megapress_act.sdat'),...
               which('debug/quickDebug/sub-02/mrs/sub-02_megapress/sub-02_megapress_act.sdat')};
...
% default.
files_ref   = {which('debug/quickDebug/sub-01/mrs/sub-01_megapress_ref/sub-01_megapress_ref.sdat'),...
               which('debug/quickDebug/sub-02/mrs/sub-02_megapress_ref/sub-02_megapress_ref.sdat')};

% Specify water data for quantification (e.g. short-TE water scan)
% (OPTIONAL)
files_w     = {which('debug/quickDebug/sub-01/mrs/sub-01_press_ref/sub-01_press_ref.sdat'),...
