%% jobMEGAPRESSquickDebug.m
%   This function is a jobMEGAPRESSquickDebug.m file .
%
...
% (MANDATORY)
files       = {which('debug/quickDebug/sub-01/mrs/sub-01_megapress/sub-01_megapress_act_noID.sdat'),...
               which('debug/quickDebug/sub-02/mrs/sub-02_megapress/sub-02_megapress_act_noID.sdat')};
...
% default.
files_ref   = {which('debug/quickDebug/sub-01/mrs/sub-01_megapress_ref/sub-01_megapress_ref_noID.sdat'),...
               which('debug/quickDebug/sub-02/mrs/sub-02_megapress_ref/sub-02_megapress_ref_noID.sdat')};

% Specify water data for quantification (e.g. short-TE water scan)
% (OPTIONAL)
files_w     = {which('debug/quickDebug/sub-01/mrs/sub-01_press_ref/sub-01_press_ref_noID.sdat'),...
...
files_nii   = {which('debug/quickDebug/sub-01/anat/sub-01_T1w.nii'),...
               which('debug/quickDebug/sub-02/anat/sub-02_T1w.nii')};
...
% (MANDATORY)
outputFolder = strrep(which('debug/jobTesting.m'),'jobTesting.m','derivatives');
