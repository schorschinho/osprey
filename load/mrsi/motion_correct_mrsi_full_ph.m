...
for this_kx = 1:size(on_spec_k_1,1)
    for this_ky = 1:size(on_spec_k_1,2)
        ...
        this_on1_lip = real(squeeze(on_spec_k_1( this_kx, this_ky, met_start_lip:met_end_lip)));
        this_off1_lip = real(squeeze(off_spec_k_1( this_kx, this_ky, met_start_lip:met_end_lip)));
        this_on2_lip = real(squeeze(on_spec_k_2( this_kx, this_ky, met_start_lip:met_end_lip)));
        this_off2_lip = real(squeeze(off_spec_k_2( this_kx, this_ky, met_start_lip:met_end_lip)));
        
        this_on1_lip_im = squeeze(on_spec_k_1( this_kx, this_ky, met_start_lip:met_end_lip));
        this_off1_lip_im = squeeze(off_spec_k_1( this_kx, this_ky, met_start_lip:met_end_lip));
        this_on2_lip_im = squeeze(on_spec_k_2( this_kx, this_ky, met_start_lip:met_end_lip));
        this_off2_lip_im = squeeze(off_spec_k_2( this_kx, this_ky, met_start_lip:met_end_lip));

        this_on1_crcho = real(squeeze(on_spec_k_1( this_kx, this_ky, met_start_crcho:met_end_crcho)));
        this_off1_crcho = real(squeeze(off_spec_k_1( this_kx, this_ky, met_start_crcho:met_end_crcho)));
        this_on2_crcho = real(squeeze(on_spec_k_2( this_kx, this_ky, met_start_crcho:met_end_crcho)));
        this_off2_crcho = real(squeeze(off_spec_k_2( this_kx, this_ky, met_start_crcho:met_end_crcho)));
