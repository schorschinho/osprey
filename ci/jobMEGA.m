...
% (MANDATORY)
files       = {which('ci/rawdata_CI/sub-01/mrs/sub-01_megapress/sub-01_megapress_act_noID.sdat'),...
               which('ci/rawdata_CI/sub-02/mrs/sub-02_megapress/sub-02_megapress_act_noID.sdat')};
...
% default.
files_ref   = {which('ci/rawdata_CI/sub-01/mrs/sub-01_megapress_ref/sub-01_megapress_ref_noID.sdat'),...
               which('ci/rawdata_CI/sub-02/mrs/sub-02_megapress_ref/sub-02_megapress_ref_noID.sdat')};
...
% (MANDATORY)
outputFolder = strrep(which('ci/jobMEGA.m'),'jobMEGA.m','derivatives');
