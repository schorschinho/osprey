...
%       2020-09-03: First version of the code.
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.SpecifySequenceInformationPanel.ForegroundColor = [0 0.4471 0.7412];
            ...
            app.SpecifySequenceInformationPanel.Position = [21 725 350 102];
            ...
            app.TextArea.FontColor = [0 0.451 0.7412];
            app.TextArea.BackgroundColor = [0.902 0.902 0.902];
            app.TextArea.Position = [21 840 350 34];
            app.TextArea.Value = {'Specify Osprey Job Parameters'};

            % Create SpecifyDataHandlingandModelingOptionsPanel
            app.SpecifyDataHandlingandModelingOptionsPanel = uipanel(app.UIFigure);
            app.SpecifyDataHandlingandModelingOptionsPanel.ForegroundColor = [0 0.4471 0.7412];
            ...
            app.SpecifyDataHandlingandModelingOptionsPanel.Position = [21 397 350 313];
            ...
            app.SelectedMetabolitesPanel.ForegroundColor = [0 0.4471 0.7412];
            ...
            app.AspCheckBox.Position = [15 435 43 22];
            app.AspCheckBox.Value = true;
            ...
            app.CrCH2CheckBox.Position = [15 304 59 22];
            app.CrCH2CheckBox.Value = true;
            ...
            app.GPCCheckBox.Position = [15 225 48 22];
            app.GPCCheckBox.Value = true;
            ...
            app.GSHCheckBox.Position = [15 199 48 22];
            app.GSHCheckBox.Value = true;
            ...
            app.GluCheckBox.Position = [15 119 40 22];
            app.GluCheckBox.Value = true;
            ...
            app.InsCheckBox.Position = [15 39 38 22];
            app.InsCheckBox.Value = true;
            ...
            app.LacCheckBox.Position = [15 13 42 22];
            app.LacCheckBox.Value = true;
            ...
            app.NAACheckBox.Position = [93 486 46 22];
            app.NAACheckBox.Value = true;
            ...
            app.NAAGCheckBox.Position = [93 461 55 22];
            app.NAAGCheckBox.Value = true;
            ...
            app.PChCheckBox.Position = [93 435 45 22];
            app.PChCheckBox.Value = true;
            ...
            app.PCrCheckBox.Position = [93 409 42 22];
            app.PCrCheckBox.Value = true;
            ...
            app.PECheckBox.Position = [93 383 37 22];
            app.PECheckBox.Value = true;
            ...
            app.MM12CheckBox.Position = [93 199 56 22];
            app.MM12CheckBox.Value = true;
            ...
            app.MM14CheckBox.Position = [93 172 56 22];
            app.MM14CheckBox.Value = true;
            ...
            app.MM17CheckBox.Position = [93 146 56 22];
            app.MM17CheckBox.Value = true;
            ...
            app.MM20CheckBox.Position = [93 119 56 22];
            app.MM20CheckBox.Value = true;
            ...
            app.Lip09CheckBox.Position = [93 92 52 22];
            app.Lip09CheckBox.Value = true;
            ...
            app.Lip13CheckBox.Position = [93 65 52 22];
            app.Lip13CheckBox.Value = true;
            ...
            app.Lip20CheckBox.Position = [93 39 52 22];
            app.Lip20CheckBox.Value = true;

            % Create SpecifyMRSandStructuralImagingFilesPanel
            app.SpecifyMRSandStructuralImagingFilesPanel = uipanel(app.UIFigure);
            app.SpecifyMRSandStructuralImagingFilesPanel.ForegroundColor = [0 0.4471 0.7412];
            ...
            app.SpecifyMRSandStructuralImagingFilesPanel.Position = [21 132 350 249];
            ...
            app.MRSDataButton.FontColor = [0 0.4471 0.7412];
            ...
            app.H2OReferenceButton.FontColor = [0 0.4471 0.7412];
            app.H2OReferenceButton.Enable = 'off';
            ...
            app.H2OShortTEButton.FontColor = [0 0.4471 0.7412];
            ...
            app.MetaboliteNulledButton.FontColor = [0 0.4471 0.7412];
            ...
            app.T1DataniftiniiButton.FontColor = [0 0.4471 0.7412];
            ...
            app.SpecifyOutputFolderPanel.ForegroundColor = [0 0.4471 0.7412];
            ...
            app.SpecifyOutputFolderPanel.Position = [21 11 349 107];
            ...
            app.OutputFolderButton.FontColor = [0 0.4471 0.7412];
            ...
            app.CANCELButton.BackgroundColor = [0.651 0.651 0.651];
            app.CANCELButton.FontSize = 15;
            app.CANCELButton.FontWeight = 'bold';
            app.CANCELButton.FontColor = [0 0.4471 0.7412];
            app.CANCELButton.Position = [386 224 160 43];
            ...
            app.CREATEJOBButton.BackgroundColor = [0.651 0.651 0.651];
            app.CREATEJOBButton.FontSize = 15;
            app.CREATEJOBButton.FontWeight = 'bold';
            app.CREATEJOBButton.FontColor = [0 0.4471 0.7412];
            app.CREATEJOBButton.Position = [386 170 160 43];
