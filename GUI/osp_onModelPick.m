function osp_onModelPick( source, ~ ,gui)
%% osp_onModelPick
...
%%% 2. UPDATEWINDOW %%%    
    ...
    gui.controls.ModelPick.Value = selectedModel;
    gui.controls.ModelPick.Tooltip = ['Model Chosen: ' num2str(selectedModel)];

    %sprintf('gui: %i',gui.controls.ModelPick.Value)
