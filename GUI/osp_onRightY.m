function osp_onRightY( ~, ~ ,gui)
%% osp_onRightX
%   Callback function on process click on left y voxel direction button.
%
%
%   USAGE:
%       osp_onRightY( ~, ~ ,gui);
...
%%% 2. UPDATEWINDOW %%%    
    ...
    if gui.controls.act_y < gui.info.nYvoxels
        gui.controls.act_y = gui.controls.act_y + 1;

        setappdata(gui.figure,'MRSCont',MRSCont); % Write MRSCont into hidden container in gui class
        set(gui.controls.text_act_y,'String',num2str(gui.controls.act_y));
