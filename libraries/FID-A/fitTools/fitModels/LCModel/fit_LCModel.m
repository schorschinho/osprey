...
%
% USAGE:
% [fitParams] = fit_LCModel(dataToFit, resBasisSet, fitOpts);
% 
% DESCRIPTION:
% This is the function describing the LCModel fitting model, which is
...
function [fitParams, resBasisSet] = fit_LCModel(dataToFit, basisSet, fitOpts)
...
[fitParamsStep1] = fit_LCModel_PrelimReduced(dataToFitRef, resBasisSet, minKnotSpacingPPM, fitRangePPM);
...
[fitParamsStep2] = fit_LCModelPrelimStep2(dataToFitRef, resBasisSet, minKnotSpacingPPM, fitRangePPM, fitParamsStep1, refFWHM);
