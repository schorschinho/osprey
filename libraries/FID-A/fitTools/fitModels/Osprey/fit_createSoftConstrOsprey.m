...
% identical length.
constr1.met     = {'Lip13', 'Lip13', 'MM09', 'MM09', 'MM09', 'MM09', 'NAA'};
constr1.wght    = [1        1        1       1       1       1       1];
constr2.met     = {'Lip09', 'Lip20', 'MM20', 'MM12', 'MM14', 'MM17', 'NAAG'};
constr2.wght    = [0.267    0.15     1.5     0.3     0.75    0.375   0.15];
