...
if addMMFlag
    ...
    %More MM signals Added (RE) to match parametrization in Giapitzakis
    MM09            = op_gaussianPeak(n,sw,Bo,centerFreq,0.14*hzppm,0.94,3*oneProtonArea/gaussianArea);
    MMBase.MM09     = op_dccorr(MM09,'p');
    MM12            = op_gaussianPeak(n,sw,Bo,centerFreq,0.15*hzppm,1.22,2*oneProtonArea/gaussianArea);
    ...
    MM17            = op_gaussianPeak(n,sw,Bo,centerFreq,0.15*hzppm,1.69,2*oneProtonArea/gaussianArea);
    MMBase.MM17     = op_dccorr(MM17,'p');
    MM20           = op_gaussianPeak(n,sw,Bo,centerFreq,0.15*hzppm,2.04,1.33*oneProtonArea/gaussianArea);
    MM23           = op_gaussianPeak(n,sw,Bo,centerFreq,0.2*hzppm,2.27,0.33*oneProtonArea/gaussianArea);
    MM26           = op_gaussianPeak(n,sw,Bo,centerFreq,0.15*hzppm,2.57,0.33*oneProtonArea/gaussianArea);
    MM27           = op_gaussianPeak(n,sw,Bo,centerFreq,0.15*hzppm,2.75,0.33*oneProtonArea/gaussianArea);
    MM30           = op_gaussianPeak(n,sw,Bo,centerFreq,0.2*hzppm,3.0,0.4*oneProtonArea/gaussianArea);
    ...
    MMBase.MM26     = op_dccorr(MM26,'p');
    MMBase.MM27     = op_dccorr(MM27,'p');
    MMBase.MM30     = op_dccorr(MM30,'p');
    MM32            = op_gaussianPeak(n,sw,Bo,centerFreq,0.15*hzppm,3.21,2*oneProtonArea/gaussianArea);
    MMBase.MM32     = op_dccorr(MM32,'p');
    MM37            = op_gaussianPeak(n,sw,Bo,centerFreq,0.15*hzppm,3.71,2*oneProtonArea/gaussianArea);
    MMBase.MM37     = op_dccorr(MM37,'p');
    MM38            = op_gaussianPeak(n,sw,Bo,centerFreq,0.15*hzppm,3.79,2*oneProtonArea/gaussianArea);
    MMBase.MM38     = op_dccorr(MM38,'p');
    MM39            = op_gaussianPeak(n,sw,Bo,centerFreq,0.15*hzppm,3.87,2*oneProtonArea/gaussianArea);
    MMBase.MM39     = op_dccorr(MM39,'p');
    MM40            = op_gaussianPeak(n,sw,Bo,centerFreq,0.15*hzppm,3.97,2*oneProtonArea/gaussianArea);
    MMBase.MM40     = op_dccorr(MM40,'p');
    MM42            = op_gaussianPeak(n,sw,Bo,centerFreq,0.15*hzppm,4.2,2*oneProtonArea/gaussianArea);
    MMBase.MM42     = op_dccorr(MM42,'p');    
    ...
    MMLips = {'MM09','MM12','MM14','MM17','MM20','MM23','MM26','MM27','MM30','MM32','MM37','MM38','MM39','MM40','MM42','Lip09','Lip13','Lip20'};
