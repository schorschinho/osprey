...
%
% USAGE:
% RF=io_writespar(in,outfile);
% 
% DESCRIPTION:
% Takes MRS jeader data in matlab structure format and writes it to a SPAR file
% that can be read by LCModel.
% 
% INPUTS:
% in         = input data in matlab structure format.
% sparFile   = Desired filename of output SPAR file.
%
% OUTPUTS:
% RF         = Same as input.  Not used.  The primary output of this
%                function is a text file in SDAT format. 

function RF=io_writespar(in,sparFile);
%function RF=io_writespar(in,sparFile);
