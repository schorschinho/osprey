...
elseif isSiemens
    ...
    elseif ~isempty(strfind(sequence,'svs_se'))
        seq = 'PRESS';
%    elseif ~isempty(strfind(sequence,'\svs_edit')) % scnh, for XA50 Siemens svs_edit MEGA
%        seq = 'MEGAPRESS';                         % scnh, for XA50 Siemens svs_edit MEGA
    end
end
if isDondersMRSfMRI
    seq = 'SLASER_D';
...
if (strcmp(version,'vd') || strcmp(version,'vb') || strcmp(version,'XA30') || strcmp(version,'XA50'))    % scnh
...
if strcmp(version,'vd') || strcmp(version,'ve') || strcmp(version,'XA30') || strcmp(version,'XA50') % scnh    
...
if ~isempty(dimsToIndex)
    ...
    elseif isWIP859
        dims.subSpecs=find(strcmp(sqzDims,'Ide'));
%    elseif issvs_edit                              % scnh, for XA50 Siemens svs_edit MEGA
%        dims.subSpecs=find(strcmp(sqzDims,'Ide')); % scnh, for XA50 Siemens svs_edit MEGA
    else
