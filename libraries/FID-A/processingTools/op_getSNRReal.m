...
function [SNR]=op_getSNRReal(in,NAAppmmin,NAAppmmax,noiseppmmin,noiseppmmax);
...
maxNAA_index=find(real(NAAwindow)==max(real((NAAwindow))));
...
%figure
%plot(ppmwindow2,real(noisewindow),..C:\Users\dsimici1\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\GitHub, Inc\osprey\libraries\FID-A\processingTools\op_getSNR.m.
