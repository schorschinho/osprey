function [MRSCont] = LCG_processHERMES(MRSCont)
...
for kk = 1:MRSCont.nDatasets
    ...
    if ~raw.flags.averaged
        raw_A   = op_robustSpecReg(raw_A, 'HERMES', 1);
        raw_B   = op_robustSpecReg(raw_B, 'HERMES', 1);                  
        raw_C   = op_robustSpecReg(raw_C, 'HERMES', 1);                    
        raw_D   = op_robustSpecReg(raw_D, 'HERMES', 1);
    end
    ...
    [raw_A, raw_B, raw_C, raw_D] = LCG_onOffClassifyHERMES(raw_A, raw_B, raw_C, raw_D);
    ...
    [raw_A, raw_B, raw_C, raw_D] = LCG_editSubSpecAlign(raw_A, raw_B, raw_C, raw_D);
