function [varargout] = osp_editSubSpecAlignGauss09(varargin)
...
freqLim = ppm <= 0.9+0.15 & ppm >= 0.9-0.15;
...
x0 = lsqcurvefit(@GaussModel, x0, ppm(freqLim)', real(specRange), lb, ub, lsqopts);
