...
% (MANDATORY)
files       = {strrep(which('exampledata/rda/jobRDA.m'),'jobRDA.m','sub-01/mrs/sub-01_acc-press/')...
               strrep(which('exampledata/rda/jobRDA.m'),'jobRDA.m','sub-01/mrs/sub-01_pcg-press/'),...
               strrep(which('exampledata/rda/jobRDA.m'),'jobRDA.m','sub-01/mrs/sub-01_thal-press/')};
