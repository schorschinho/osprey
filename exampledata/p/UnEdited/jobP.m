...
% opts.fit.basisSetFile = 'opts.fit.basisSetFile = 'osprey/fit/basissets/3T/ge/unedited/press/35/basis_ge_press35.mat';
...
data_folder = fileparts(which(fullfile('exampledata','p','UnEdited','jobP.m'))); 
